...
document.getElementById("submitBtn").addEventListener('click', function () {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + cityInput + '&units=metric&appid=24862cb6763f1a43e752222c0aaa8220')
        .then(res => res.json())
        .then(data => {
...
function defaultCity() {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + defaultCityDhaka + '&units=metric&appid=24862cb6763f1a43e752222c0aaa8220')
        .then(res => res.json())
        .then(data => {
            document.getElementById("city").innerText = data['name'];
            document.getElementById("currentTemp").innerText = data['main']['temp'];
